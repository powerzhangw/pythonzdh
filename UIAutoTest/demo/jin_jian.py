...
def get_datas(repayMethodText,customerName,deptID,funder,productId,amount,get_cod,funderProductConfig,time):
        url = 'http://postlend.demo.ejie365.cn/external/core/order/test'
...
# # cc = get_datas(u'等额本息','调试一','33f1f497727b402c95607439f522ef68','0009800003','0012600001',"100",'2019032100005','213f18b0dca4486bbcced92e4c1f725a','1530775361787')
# # print(cc)
